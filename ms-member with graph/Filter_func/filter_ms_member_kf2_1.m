function output_member = filter_ms_member_kf2_1(filter, model, meas, truth)
...
if empty_data
    ...
    P_partition=myfind_partitions1(model, filter, MS_MeMBer_predict, Z);
    sub=P_partition.sub;
