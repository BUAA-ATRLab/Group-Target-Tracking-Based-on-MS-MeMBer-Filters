% original mySD.m was finished on Jun.9, 1999
% using Accelerated Subgradient Update method
% modified by Ren Xiaoyi for large scale problems

function [gam, cost] = mysdassignment(sub, val)
...
ind1 = sub2ind(n, c1{:});
c2 = mat2cell(gam, size(gam,1), ones(1, S));
ind2 = sub2ind(n, c2{:});
